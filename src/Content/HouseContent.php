...
final class HouseContent
{
    ...
    {
        return 'Сейчас ты здесь, а эта страница - место входа в мою цифровую экосистему: пример, как я организую среду в интернете и куда приглашаю тебя. К соавторству, партнёрству, сотрудничеству. Или просто побыть - сделать выдох и вдох';
    }
