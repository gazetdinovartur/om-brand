    ...
    public static function blocks(): array
    {
        return [
            ...
            [
                ...
                'title' => 'Своё решение',
                'subtitle' => null,
                'body' => 'Если готового решения не существует или оно неудобно для вашей работы — разработаем собственное. Индивидуальное, созданное под вашу задачу. В таких проектах сейчас мой основной интерес — увидеть ваш способ работы и сделать инструмент, который высвобождает внимание',
                'items' => null,
                'sortOrder' => 60,
            ],
            [
            ...
            [
                ...
                'items' => [
                    ['title' => 'Почасовая', 'text' => 'консультации, аудит, точечные доработки и задачи без жёсткой оценки объёма', 'price' => 'от 1500 ₽/ч'],
