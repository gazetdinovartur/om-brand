...
final class LandingContent
{
    ...
    {
        return 'Занимаюсь заказной разработкой и реализацией проектов мечты. Для бизнеса, сообществ и частных специалистов';
    }
    ...
    public static function blocks(): array
    {
        return [
            ...
            [
                ...
                'title' => 'Мой подход',
                'subtitle' => null,
                'body' => "На пересечении технического и человеческого: проясняю путь от задачи до результата, проектирую интерфейс — и только после этого пишу код\n\nТак получается инструмент, понятный с первого раза: без инструкций, обучения и звонков «куда нажать»",
                'items' => null,
                'sortOrder' => 40,
            ],
            [
